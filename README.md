...
*** !!! Enabling is necessary via Azure Monitor -> Virtual Machines -> Select VMSS -> Insights (under Monitoring) -> Enable !!! ***
...
2. Once you log in to one of the VMSS instances, deploy the application manually:
      ...
      pip install -r requirements.txt
      # Make sure, you aer in the Deploy_to_VMSS branch
      git checkout Deploy_to_VMSS
      # Make sure redis-server is installed and redis-server is running
      # How to install and start Redis server. Refer https://redis.io/download for help.
